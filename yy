...
General configuration of rclone.
      ...
      --cache-dir string                    Directory rclone will use for caching (default "C:\\Users\\vsuh\\AppData\\Local\\rclone")
      --color string                        When to show colors (and other ANSI codes) AUTO|NEVER|ALWAYS (default "AUTO")
      --config string                       Config file (default "C:\\Users\\vsuh\\AppData\\Roaming\\rclone\\rclone.conf")
  ...
  -i, --interactive                         Enable interactive mode
      ...
      --temp-dir string                     Directory rclone will use for temporary files (default "C:\\Users\\vsuh\\AppData\\Local\\Temp")
...
Backend only flags. These can be set in the config file also.
      ...
      --cache-chunk-path string                             Directory to cache chunk files (default "C:\\Users\\vsuh\\AppData\\Local\\rclone\\cache-backend")
      ...
      --cache-db-path string                                Directory to store file structure metadata DB (default "C:\\Users\\vsuh\\AppData\\Local\\rclone\\cache-backend")
  ...
  -L, --copy-links                                          Follow symlinks and copy the pointed to item
      ...
      --ftp-user string                                     FTP username (default "IC\\vsuh")
  ...
  -l, --links                                               Translate symlinks to/from regular files with a '.rclonelink' extension
      ...
      --local-encoding MultiEncoder                         The encoding for the backend (default Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,Ctl,RightSpace,RightPeriod,InvalidUtf8,Dot)
  ...
  -x, --one-file-system                                     Don't cross filesystem boundaries (unix/macOS only)
      ...
      --sftp-user string                                    SSH username (default "IC\\vsuh")
      ...
      --smb-user string                                     SMB username (default "IC\\vsuh")
